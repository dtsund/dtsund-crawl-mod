...
void initialise_branch_depths()
{
    ...
    // dtsund: Always disable Shoals.  Not removing Shoals code because it'd
    // make a fantastic portal vault.
    // Addendum: I've reverted this.  Shoals is back in, at least for now.
